...
try:
	...
	admin_name  = "@tvojakoroleva" # Admin UserName
	support_name = "@tvojakoroleva" # Support Username
	bot_name    = "hqdjullvape61_bot" # Project Name
	admin       = "1278738641" # Admin id
	token       = "1538196563:AAFIDzWuGnp1ZaOCVq0IKLe4Zi-W_Ekc96U" # BOT TOKEN
	qiwi_num    = "+79XXXXXXXXXX" # QIWI NUMBER
	qiwi_tok    = "XXXXXXXXXXXXXXXXXXXXXXXXXXX" #QIWI TOKEN
